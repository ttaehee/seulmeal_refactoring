		...
		<form class="form-signin" method="post" action="/user/resetUserPassword" target="_self">
			<section class="login-wrap">
				...
				<div class="login-id-wrap">
					<input id="password" name="userId" placeholder="아이디" type="password"></input>
				</div>
				...
				<div class="login-pw-wrap">
					<input id="confirmPassword" name="password" placeholder="비번" type="password"></input>
				</div>
				<div class="message-wrap">
				<div id="passCheck" style="font-size: 12px; color:crimson; text-align: left;"></div>
				</div>
				<div class="login-btn-wrap">
					<button id="login-btn" type="submit">확 인</button>
				</div>
